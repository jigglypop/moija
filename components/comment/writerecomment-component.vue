<template>
  <div class="writecomment-outer">
    <form @submit.prevent="onWriteReComment" class="writecomment-div">
      <textarea type="text" v-model="content" />
      <wave-button type="submit"><h4>대댓글 쓰기</h4></wave-button>
...
export default Vue.extend({
  ...
  methods: {
    ...
    async onWriteReComment(){
      await this.WRITECOMMENT({
        postId: this.$route.params.post,
        commentId: this.comment.openId,
